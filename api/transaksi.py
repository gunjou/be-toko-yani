...
item_model = transaksi_ns.model("Item", {
    ...
    "harga_jual": fields.Integer(
        required=True,
        description="Harga jual satuan produk"
    ),
})
...
transaksi_model = transaksi_ns.model("Transaksi", {
    ...
    "id_pelanggan": fields.Integer(
        required=False,
        description="ID pelanggan (opsional)"
    ),

    "nama_pelanggan": fields.String(
        required=False,
        description="Nama pelanggan baru"
    ),

    "kontak": fields.String(
        required=False,
        description="Kontak pelanggan baru"
    ),

    "alamat": fields.String(
        required=False,
        description="Alamat pelanggan baru"
    ),
    ...
    "tunai": fields.Integer(
        required=True,
        description="Uang tunai"
    ),

    "kembalian": fields.Integer(
        required=False,
...
class TransaksiListResource(Resource):
    ...
    @transaksi_ns.doc(params={
        ...
        'tanggal': 'Filter berdasarkan tanggal transaksi (YYYY-MM-DD)',
        'status_hutang': 'Filter status hutang (lunas/belum lunas)',
